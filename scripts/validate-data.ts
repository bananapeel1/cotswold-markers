...
const LOCKED_MARKER_COORDS: Record<string, { lat: number; lng: number }> = {
  ...
  "cw-04-stanway-house": { lat: 51.98958, lng: -1.91255 },
  "cw-19-hailes-abbey": { lat: 51.96938, lng: -1.92772 },
  "cw-21-sudeley-castle": { lat: 51.95085, lng: -1.96706 },
  ...
  "cw-06-cleeve-hill": { lat: 51.92975, lng: -2.02457 },
  ...
  "cw-32-haresfield-beacon": { lat: 51.76505, lng: -2.24634 },
