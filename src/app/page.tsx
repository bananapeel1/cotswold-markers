  ...
  return (
    <>
      ...
      <main className="pt-16 pb-24 md:pb-0">
        {/* Hero */}
        <section className="relative min-h-[85vh] md:min-h-screen w-full flex items-end overflow-hidden bg-primary">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-t from-on-surface/90 via-on-surface/30 to-on-surface/10" />
          <div className="relative z-10 w-full max-w-7xl mx-auto px-6 pb-12 md:pb-20">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-8">
              ...
              <div className="max-w-xl">
                ...
                <h1 className="font-headline text-4xl md:text-6xl lg:text-7xl font-extrabold text-on-primary leading-[1.05] tracking-tight mb-5">
                  {settings.tagline.split("\n").map((line: string, i: number) => (
                    <span key={i}>{i > 0 && <br />}{line}</span>
                  ))}
                </h1>
                <p className="text-on-primary/90 text-base md:text-lg max-w-md mb-8 leading-relaxed font-medium">
